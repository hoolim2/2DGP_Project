...
def enter():
    global background,line_one,line_two,line_three,line_four,line_five,slash_fx,magic_fx,heal_fx,drain_fx,slashad_fx,blood_fx,heart,damage_fx
    createCharacter()
    line_one=lineOne()
    line_two = lineTwo()
